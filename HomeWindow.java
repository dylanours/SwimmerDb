...
public class HomeWindow extends JFrame {
    ...
    public static ArrayList<String> Parse(String input) {
        ...
        String[] keywords = { "help", "all", "add", "record", "swimmer", "team", "meet", "result", "delete", "fastest",
                "slowest", "male", "males", "boys", "men", "female", "females", "girls", "women", "freestyle", "free",
                "butterfly", "fly", "breaststroke", "breast", "backstroke", "back", "50", "100", "200", "400", "800",
                "1500", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven",
