...
public class HomeWindow extends JFrame {
    ...
    public static ArrayList<String> Parse(String input) {
        ...
        String[] keywords = { "help", "all", "add", "modify", "record", "relay", "swimmer", "swimmers", "teams",
                "meets", "records", "times", "results", "team", "meet", "result", "delete", "fastest", "slowest",
                "male", "males", "boys", "men", "female", "females", "girls", "women", "freestyle", "free", "butterfly",
                "fly", "breaststroke", "breast", "backstroke", "back", "50", "100", "200", "400", "800", "1500", "one",
            ...
            case "all":
                ...
                case "teams":
                    ...
                    while (resultsTeams.next()) {
                        output = output + resultsTeams.getString("TeamId") + ": " + resultsTeams.getString("TeamName")
                                + ", " + resultsTeams.getString("HeadCoach") + "\n";
                    }
                    return output;
                case "records":
                case "times":
                case "results":
                    ...
                    while (resultsRecords.next()) {
                        output = output + resultsRecords.getInt("EventId") + ": " + resultsRecords.getInt("SwimmerId")
                                + ", " + resultsRecords.getInt("Time") + ", " + resultsRecords.getInt("SanctionNumber")
                                + "\n";
                    }
                    return output;
                }
